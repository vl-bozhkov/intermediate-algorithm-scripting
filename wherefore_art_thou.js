...
function whatIsInAName(collection, source) {
  // turn source object to array of keys
  let srcKeys = Object.keys(source);
  // loop through collection objects
  let arr = collection.filter(function(obj) {
    // if there no propery in collection and object not equal to source
